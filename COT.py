...
with menu[1]:
    ...
    if len(data) == 0:
        ...
        colp1.metric("Actividades PSM (SÍ)", (df["PSM"] == "SÍ").sum())
        colp2.metric("Actividades NO PSM", (df["PSM"] == "NO").sum())
        ...
        st.plotly_chart(
            px.pie(
                ...
                values="Cantidad",
                hole=0.4,
                title="Distribución de Actividades PSM"
            ),
            use_container_width=True
        )
